...
\item \emph{Probability Distributions and Moment Matching} \& Probability Lab Exercise VI-VII %[notes: CHRIS LEAD support, pmf/pdf, cdf, quantile function, cheat sheets]
\end{itemize}
...
\item \emph{MCMC I} \& MCMC Exercises  %[notes: TOM LEAD] 
\item \emph{MCMC II} \& MCMC Exercises (on your own time) %[notes: TOM LEAD] 
